...
public class CollisionEventTrigger : MonoBehaviour {
    ...
    void OnCollisionEnter(Collision c)
    {
        ...
        if (triggerOnCollisionEnter)
        {
            ...
            collisionScore += 10 * (15 - (currentTime - startTime))/2; // the more time elpased, the less the score.
            collisionReward += 10 * (15 - (currentTime - startTime))/2;
        }
    }
    ...
    void OnTriggerEnter(Collider c)
    {
        ...
        if (triggerOnTriggerEnter)
        {
            ...
            collisionScore += 10 * (15 - (currentTime - startTime))/2;
            collisionReward += 10 * (15 - (currentTime - startTime))/2;
        }
    }
