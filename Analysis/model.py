...
from envVMWM import *
#import mobileNet
exe_location='C:\\Users\\YuHang\\Desktop\\Water_Maze\\v0.30\\VMWM.exe'
cfg_location = 'C:\\Users\\YuHang\\Desktop\\Water_Maze\\v0.30\\VMWM_data\\configuration_original.txt'
...
class Worker():
    def __init__(self,name,s_size,a_size,trainer,model_path,global_episodes,noisy,grayScale,is_training):
        ...
        self.local_AC = AC_Network(s_size,a_size,self.name,trainer_c,noisy,grayScale)
