...
class AC_Network():
    def __init__(self,s_size,a_size,scope,trainer,grayScale=True):
        ...
        with tf.variable_scope(scope):
            ...
            self.policy = slim.fully_connected(rnn_out,3,
            ...
            if scope != 'global':
                ...
                self.responsible_outputs_1 = tf.reduce_sum(self.policy * self.actions_onehot_turn, [1])
                #Loss functions
                self.value_loss = 0.5 * tf.reduce_sum(tf.square(self.target_v - tf.reshape(self.value,[-1])))
                self.policy_loss = -tf.reduce_sum(tf.log(self.responsible_outputs_1)*self.advantages)
        ...
        with sess.as_default(), sess.graph.as_default():
            ...
            while not coord.should_stop():
                ...
                while self.env.is_episode_finished() == False:
                    ...
                    episode_buffer.append([s,a_turn,r,s1,d,v[0,0]])
